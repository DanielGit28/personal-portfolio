    ...
    return (
        <section ref={sectionRef} className="projects" id="projects-section">
            ...
            <div className="projects__cnt">
                ...
                images={[{ src: '/images/projects/StartupSafeDashboard.png', alt: 'StartupSafe Project image' }, { src: '/images/projects/StartupSafeLogin.png', alt: 'StartupSafe Project image' }]} title="StartupSafe" text="Web project for Cenfotec. Consisted on a startup community platform with packages service, reviews and SSO." stageInfo={{ backgroundSrc: '/images/acuarela-celeste.jpg', alt: 'Stages info background', stages: ['Documentation', 'Back-end', 'Front-end'], orientation: 'vertical' }} />
